...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(view -> Toast.makeText(PlayActivity.this, "Đáp án là " + randomNumber, Toast.LENGTH_SHORT).show());
    ...
    public void gameStart() {
        ...
        EditText guessField = findViewById(R.id.guess_field);
        @SuppressLint("CutPasteId") TextView numberOfAttempts = findViewById(R.id.number_of_attempts);
        ...
        if (giatri == 0) {
            ...
            reset.setOnClickListener(v -> {
                dialog.dismiss();
                @SuppressLint("CutPasteId") TextView numberOfAttempts1 = findViewById(R.id.number_of_attempts);
                int minVal = 0;
                int maxVal = 100;
